...
class String 
{
    ...
    public:
        ...
        { 
            cout << "String copy constructor " << s << endl;
        ...
        {
            cout << "Move assign constructor " << rhs << endl;
            if (this != &rhs)
            {
...
{
    cout << "String Assing copy constructor: String" << endl;
...
{
    cout << "String Assing copy constructor: char *" << endl;
	if (p) a.deallocate(p, sz);
