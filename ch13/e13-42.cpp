...
class QueryResult
{
    ...
    public:
        QueryResult(const string & s, shared_ptr<set<size_t>> line_no_set, shared_ptr<StrVec> line_str_vec):
...
class TextQuery
{
    ...
    private:
        shared_ptr<StrVec> content_lines;
...
TextQuery::TextQuery(ifstream & in): content_lines(new StrVec)
{
    string line;
    string word;
    size_t n = 1;
